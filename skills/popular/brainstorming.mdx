---
title: 'Brainstorming'
description: 'Transform vague ideas into validated designs through structured dialogue'
icon: 'lightbulb'
---
...
<CardGroup cols={2}>
  ...
  <Card title="Explicit Assumptions" icon="exclamation">
  ...
  <Card title="Validate Incrementally" icon="check-double">
    Confirm understanding at each step
  </Card>
  
  <Card title="Clarity Over Cleverness" icon="sparkles">
    Prefer simple, clear solutions
  </Card>
  
  <Card title="YAGNI Ruthlessly" icon="scissors">
