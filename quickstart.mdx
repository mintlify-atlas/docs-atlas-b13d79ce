...
<Tabs>
  <Tab title="Web Dev">
    **The "Web Wizard" Pack** — For building modern, high-performance web apps
    ...
    [View complete bundle →](/guides/bundles#web-wizard)
  </Tab>
  ...
  <Tab title="Security">
    **The "Security Engineer" Pack** — For pentesting, auditing, and hardening
    ...
    [View complete bundle →](/guides/bundles#security-engineer)
  </Tab>
  ...
  <Tab title="Full-Stack">
    **The "Full-Stack Developer" Pack** — For end-to-end web application development
    ...
    [View complete bundle →](/guides/bundles#full-stack-developer)
  </Tab>
  ...
  <Tab title="DevOps">
    **The "DevOps & Cloud" Pack** — For infrastructure and scaling
    ...
    [View complete bundle →](/guides/bundles#devops-cloud)
  </Tab>
</Tabs>
...
<AccordionGroup>
  ...
  <Accordion title="Do I need to install all 968+ skills?">
    ...
    **Think of it like a library:** All books are on the shelf, but you only read the ones you need.
    ...
    Start with 3-5 skills from your role's bundle in the [Bundles Guide](/guides/bundles), then expand as needed.
  </Accordion>
  ...
  <Accordion title="What's the difference between bundles and workflows?">
    ...
    **Use bundles** when deciding which skills to use. **Use workflows** when you need guided execution for a specific goal.
    ...
    Learn more: [Bundles Guide](/guides/bundles) | [Workflows Guide](/guides/workflows)
  </Accordion>
  ...
  <Accordion title="Can I create my own custom skills?">
    **Yes!** Use the `@skill-creator` skill to build custom skills:
    ...
    See the [Contributing Guide](/community/contributing) for details on skill anatomy and quality standards.
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  <Card title="Browse Bundles" icon="layer-group" href="/guides/bundles">
  ...
  <Card title="Usage Guide" icon="graduation-cap" href="/usage/how-to-use-skills">
